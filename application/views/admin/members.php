        ...
        <form action=""  role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-6">
                            <label class="control-label"> Profile Heading <span class="symbol required" style="color: red">*</span></label>
                            <textarea name="mem_profile_heading" rows="3"  class="form-control" autofocus required><?php if (isset($row->mem_profile_heading)) echo $row->mem_profile_heading; ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="control-label"> Profile Bio <span class="symbol required" style="color: red">*</span></label>
                            <textarea name="mem_bio" rows="3"  class="form-control" autofocus required><?php if (isset($row->mem_bio)) echo $row->mem_bio; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
