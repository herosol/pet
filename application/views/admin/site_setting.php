        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label   label class="control-label" for="site_fourth_section_heading"> Fourth Section Heading  <span class="symbol required">*</span></label>
                        ...
                        <div class="col-md-12">
                            <label   label class="control-label" for="site_field_heading"> Field Heading  <span class="symbol required">*</span></label>
                            <input type="text" name="site_field_heading" value="<?php if (isset($adminsite_setting->site_field_heading)) echo $adminsite_setting->site_field_heading; ?>"  class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <label   label class="control-label" for="site_field_text"> Field Text  <span class="symbol required">*</span></label>
                            <input type="text" name="site_field_text" value="<?php if (isset($adminsite_setting->site_field_text)) echo $adminsite_setting->site_field_text; ?>"  class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <label   label class="control-label" for="site_after_field_heading"> After Field Heading  <span class="symbol required">*</span></label>
                            <input type="text" name="site_after_field_heading" value="<?php if (isset($adminsite_setting->site_after_field_heading)) echo $adminsite_setting->site_after_field_heading; ?>"  class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
