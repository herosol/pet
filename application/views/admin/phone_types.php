<?php if ($this->uri->segment(3) == 'manage'): ?>
    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= site_url(ADMIN . '/phonetypes'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
    <div>
        <hr>
        <div class="row col-md-12">
            <form action="" name="frmFaq" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        <label for="category_id" class="control-label">Product Category<span class="symbol required">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label class="control-label"> Category Type <span class="symbol required">*</span></label>
    ...
    <?php else: ?>
        ...
        <div class="row margin-bottom-10">
            <div class="col-md-6">
                <h2 class="no-margin"><i class="entypo-list"></i>Manage Types</h2>
            </div>
            <div class="col-md-6 text-right">
                <a href="<?= site_url(ADMIN . '/phonetypes/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
            </div>
        </div>
                    ...
                    <?php foreach ($rows as $row): ?>
                        <tr class="odd gradeX">
                            ...
                            <td class="text-center">
                                <a href="<?= site_url(ADMIN.'/phonetypes/manage/'.$row->id); ?>">Edit</a> |
                                <a href="<?= site_url(ADMIN.'/phonetypes/delete/'.$row->id); ?>" onclick="return confirm('Your are about to delete this record. Press OK to continue.');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
