        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="detail" class="control-label"> Left Detail <span class="symbol required">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="field_text5" class="control-label"> Fifth Field Text <span class="symbol required">*</span></label>
