...
class Index extends MY_Controller
{
    ...
    function index()
    {
        ...
        if ($data) {
            ...
            $this->data['feature_phones']    = $this->master->get_data_rows('products', ['status' => 1, 'is_featured'=> 1, 'category_id'=> 1]);
            $this->data['feature_accessories'] = $this->master->getRows('products', ['status' => 1, 'is_featured'=> 1, 'category_id'=> 2], 0, 10, 'desc', 'id');
